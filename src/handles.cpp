...
NAN_METHOD(QuantLibXL::HandleCurrentLink) {
  ...
  // launch worker
  HandleCurrentLinkWorker* worker = new HandleCurrentLinkWorker(
    ObjectIDCpp
   );
...
NAN_METHOD(QuantLibXL::HandleEmpty) {
  ...
  // launch worker
  HandleEmptyWorker* worker = new HandleEmptyWorker(
    ObjectIDCpp
   );
...
NAN_METHOD(QuantLibXL::RelinkableHandleLinkTo) {
  ...
  // launch worker
  RelinkableHandleLinkToWorker* worker = new RelinkableHandleLinkToWorker(
    ObjectIDCpp
,     CurrentLinkCpp
   );
